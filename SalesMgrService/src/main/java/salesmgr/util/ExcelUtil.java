...
public class ExcelUtil {
	...
	public static void exportExcel(OutputStream outputStream,List<Map<String, String>> list, String sheetname, String[] cols) throws Exception {
